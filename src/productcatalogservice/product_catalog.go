...
func (p *productCatalog) List(context.Context, *grpc_health_v1.HealthListRequest) (*grpc_health_v1.HealthListResponse, error){
	return status.Errorf(codes.Unimplemented, "health check via Watch not implemented"),nil
}
