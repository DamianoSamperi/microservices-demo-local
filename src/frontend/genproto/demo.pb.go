...
const file_demo_proto_rawDesc = "" +
	...
	"\x04text\x18\x02 \x01(\tR\x04text\"\x9a\x02\n" +
	...
	"\tAdService\x12;\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x002k\n" +
	"\x18ProductManagementService\x12O\n" +
	"\n" +
	"AddProduct\x12\x1e.hipstershop.AddProductRequest\x1a\x1f.hipstershop.AddProductResponse\"\x00B?Z=github.com/GoogleCloudPlatform/microservices-demo/hipstershopb\x06proto3"
